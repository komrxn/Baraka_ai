export default {
  ...
  transactions: {
    ...
    selectToDelete: 'O‘chirish uchun tranzaksiyalarni tanlang',
    deleteSelected: 'O‘chirish ({count})',
    selectedCount: 'Tanlangan: {count}',
    massDeleteSuccess: '{count} ta tranzaksiya o‘chirildi',
  ...
  subscription: {
    ...
    plans: {
      plus: {
        ...
        features: {
          model: 'Model 5-mini',
          requests: 'Limitlar: 3 kunda 250 so\'rov',
          voice: 'Kuniga 20 ovozli',
          photos: 'Kuniga 20 rasm tahlili',
          noAds: 'Reklama integratsiyasi olib tashlanadi',
        },
      },
      pro: {
        title: 'Pro',
        ...
        features: {
          model: 'Model 5-mini',
          requests: 'Limitlar: 3 kunda 400 so\'rov',
          voice: 'Kuniga 30 ovozli',
          photos: 'Kuniga 50 rasm tahlili',
        },
      },
      premium: {
        title: 'Premium',
        ...
        features: {
          model: 'Model 5.1',
          requests: 'Limitlar: "cheksiz" (3 kunda 1000 so\'rov)',
          voice: 'Ovozli: "cheksiz" (kuniga 100 ovozli)',
          photos: 'Rasmlar: "cheksiz" (kuniga 150 rasm tahlili)',
        },
      },
      monthly: {
        title: 'Oylik reja',
