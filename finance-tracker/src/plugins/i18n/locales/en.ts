export default {
  ...
  transactions: {
    ...
    selectToDelete: 'Select transactions to delete',
    deleteSelected: 'Delete ({count})',
    selectedCount: '{count} selected',
    massDeleteSuccess: '{count} transactions deleted',
  ...
  categoryList: {
    ...
    medicine: 'Medicine',
    doctors: 'Doctors',
    groceries_optional: 'Snacks/Treats',
    dentistry: 'Dentistry',
    clothing: 'Clothing',
    shoes: 'Shoes',
  ...
  subscription: {
    ...
    startTrial: 'Start Free Trial (3 days)',
    continue: 'Continue',
    ...
    total: 'Total',
    pay: 'Pay {price}',
    paymentError: 'Error creating payment link',
    trialError: 'Error activating trial',
    periods: {
      month: 'Month',
      quarter: '3 months',
      savings: 'Savings',
    ...
    plans: {
      plus: {
        ...
        features: {
          model: 'Model 5-mini',
          requests: 'Limits: 250 requests per 3 days',
          voice: '20 voice per day',
          photos: '20 image analysis per day',
          noAds: 'Ad integration removed',
        },
      },
      pro: {
        title: 'Pro',
        ...
        features: {
          model: 'Model 5-mini',
          requests: 'Limits: 400 requests per 3 days',
          voice: '30 voice per day',
          photos: '50 image analysis per day',
        },
      },
      premium: {
        title: 'Premium',
        ...
        features: {
          model: 'Model 5.1',
          requests: 'Limits: "unlimited" (1000 requests per 3 days)',
          voice: 'Voice: "unlimited" (100 voice per day)',
          photos: 'Images: "unlimited" (150 image analyses per day)',
        },
      },
      monthly: {
        title: 'Monthly plan',
