  ...
  subscription: {
    ...
    plans: {
      plus: {
        ...
        features: {
          model: 'Модель 5-mini',
          requests: 'Лимиты: 250 запросов в 3 дня',
          voice: '20 голосовых в день',
          photos: '20 анализ изображений в день',
          noAds: 'Рекламная интеграция убирается',
        },
      },
      pro: {
        title: 'Pro',
        ...
        features: {
          model: 'Модель 5-mini',
          requests: 'Лимиты: 400 запросов в 3 дня',
          voice: '30 голосовых в день',
          photos: '50 анализ изображений в день',
        },
      },
      premium: {
        title: 'Premium',
        ...
        features: {
          model: 'Модель 5.1',
          requests: 'Лимиты: "бесконечно" (1000 запросов в 3 дня)',
          voice: 'Голосовые: "бесконечно" (100 голосовых в день)',
          photos: 'Изображения: "бесконечно" (150 изображений анализов в день)',
        },
      },
      monthly: {
        title: 'Месячный план',
